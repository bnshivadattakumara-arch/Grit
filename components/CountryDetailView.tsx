      ...
      <div className="h-20 border-b-2 border-terminal-darkGreen flex items-center px-6 bg-[#050505] gap-8 shrink-0 relative">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            <h2 className={`text-2xl font-black text-white tracking-tighter uppercase ${['IND', 'ISR'].includes(countryId || '') ? 'terminal-glow' : ''}`}>
                ...
                {loading ? (
                  ...
                  >
                    <td className="p-4 pl-6">
                      <div className="flex items-center gap-3">
                        <span className={`font-black group-hover:text-terminal-green transition-colors ${['IND', 'ISR'].includes(countryId || '') ? 'text-terminal-green' : 'text-white'}`}>{s.symbol}</span>
